...
class HumanPlayer(Player):
    ...
    def get_move(self,game):
        ...
        while not valid_square:
            ...
            # we're going to check if this value is correct by trying to cast
...
class GeniusComputerPlayer(Player):
    ...
    def get_move(self,game):
        if len(game.available_moves()) == 9:
            square = random.choice(game.available_moves()) # randomly chooses a square
        else:
            # choose a sqaure based of minimax algorithm 
            # minimax function is a recursive function
            square = self.minimax(game, self.letter)["position"]
        return square
    
    # use state instead of game because at each stage of minimax we are passing in a 
    # representation of the game in that state i.e. screenshots of the game
    def minimax(self, state, player):
        ...
        for possible_move in state.available_moves():
            ...
            # step 2: recurse using minimaxto simulate a game after making that move
            ...
            # step 4: update the dictionariesif necessary 
            if player == max_player:
